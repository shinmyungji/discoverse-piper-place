...
class MinkIK:
    def __init__(self, mj_model: mujoco.MjModel, ndof_arm: int, frame_name: str = "endpoint", frame_type: str = "site"):
        self.ndof_arm = ndof_arm
    ...
    def converge_ik(self, dt: float=0.0):
    ...
    def solve_ik(self, 
        ...
        solution = self.configuration.data.qpos[:self.ndof_arm]
